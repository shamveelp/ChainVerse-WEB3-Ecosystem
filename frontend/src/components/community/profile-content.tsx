...
const userPosts = [
  ...
  },
  {
    ...
    content: 'Building in Web3 has been an incredible journey. From my first Hello World contract to now auditing protocols with $100M+ TVL. The learning never stops! 💪\n\nWhat\'s your Web3 journey been like?',
    timestamp: '1d',
    likes: 1245,
    comments: 89,
    reposts: 234,
...
const likedPosts = [
  {
    ...
    content: 'The road to Ethereum 2.0 has been long, but we\'re finally seeing the fruits of years of research and development. Exciting times ahead! 🚀',
    timestamp: '6h',
    likes: 3421,
    comments: 456,
    reposts: 1234,

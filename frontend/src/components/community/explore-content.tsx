...
import { Search, TrendingUp, Clock, Users, Star, Filter } from 'lucide-react'
...
const popularCommunities = [
  ...
  },
  {
    ...
    description: 'Smart contract auditing and security best practices',
    category: 'Security',
    growth: '+22%'
  },
  {
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-1 mb-1">
                      <p className="font-semibold text-white group-hover:text-cyan-300">{person.name}</p>
                      {person.verified && (
                    ...
                    <p className="text-slate-400 text-sm mb-1">@{person.username}</p>
                    <p className="text-slate-500 text-xs">{person.bio}</p>
                  </div>

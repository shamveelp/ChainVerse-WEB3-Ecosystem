...
export default function MessagesPage() {
  ...
  return (
    <div className="flex min-h-screen bg-slate-950">
      ...
      {/* Messages Layout */}
      <div className="flex-1 lg:ml-80 flex min-h-screen">
        {/* Conversations List */}
        <div className="w-full sm:w-80 sm:border-r border-slate-700/50 bg-slate-900/30">
        ...
        {/* Chat Area - Only show on larger screens or when conversation selected */}

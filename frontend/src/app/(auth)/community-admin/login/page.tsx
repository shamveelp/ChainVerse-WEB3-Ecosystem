...
import { Eye, EyeOff, Mail, Lock, Home, Users } from 'lucide-react'
import { useCommunityAdminAuthActions } from '@/lib/communityAdminAuthActions'
import { CommunityAdminPreventLoggedIn } from '@/redirects/communityAdminRedirects'
    ...
    <CommunityAdminPreventLoggedIn>
      <div className="min-h-screen bg-black relative overflow-hidden">
        ...
        <div className="absolute top-6 left-6 z-50">
          <Button
            onClick={() => router.push('/community-admin/get-started')}
            variant="ghost"
            ...
            <CardContent className="space-y-6">
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                <div className="flex justify-end">
                  <Button
                    type="button"
                    variant="link"
                    onClick={() => router.push('/community-admin/forgot-password')}
              ...
              <div className="text-center pt-4 border-t border-red-800/30">
                <p className="text-gray-400">
                  ...
                  <Button
                    variant="link"
                    onClick={() => router.push('/community-admin/create-community')}

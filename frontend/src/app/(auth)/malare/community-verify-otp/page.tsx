...
import { verifyOtp } from '@/services/communityAdminApiService'
...
export default function CommunityOTPVerificationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await verifyOtp(tempEmail, otpString)
      ...
      if (result.success) {
        ...
        router.push('/malare/application-submitted')
      } else {
        toast({
          title: "Error",
  ...
  const handleResend = async () => {
    ...
    // Simulate resending - you can implement actual resend logic here
    setTimeout(() => {
      setResending(false)
      toast({
        title: "Success",
